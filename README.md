<h1 align="center">syncRedmine</h1>

<p align="center">
  <b>提交代码后，自动将 commit 信息同步到 Redmine 对应问题</b>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/python-3.6+-blue?logo=python&logoColor=white" alt="Python">
  <img src="https://img.shields.io/badge/platform-Ubuntu-orange?logo=ubuntu&logoColor=white" alt="Platform">
  <img src="https://img.shields.io/badge/UI-PyQt5-green?logo=qt&logoColor=white" alt="PyQt5">
</p>
...
> | **智能检测** | 优先按 Bug number 关联，兼容 Topic ID；change 快照对比 + 最近更新时间兜底 |
...
> [!TIP]
> 如果 `pip` 版本过旧，`PyQt5` 可能退回源码构建导致失败。安装脚本会先尝试升级 `pip` 以避免此问题。
...
| **自动更新** | 每天 10:00 通过 SSH 从源机器同步仓库快照，发现新版本后自动覆盖安装并重启。设置页也支持手动"同步代码" |
